...
var installHectane = function() {
    mods.console.log();
    mods.console.log("ACTION REQUIRED: ADD THE HECTANE PLUGIN TO YOUR WORDPRESS INSTALL");
    mods.console.log();
    // TODO: Install hectane using wp-cli?
};

var composeUp = R.curry(function(mode, conf) {
    var compose = mods.deploys.compose.bind(null, conf);
    ...
    if (mode === 'deploy')
        mods.utils.sleep(60000, 'Preparing mysql');
